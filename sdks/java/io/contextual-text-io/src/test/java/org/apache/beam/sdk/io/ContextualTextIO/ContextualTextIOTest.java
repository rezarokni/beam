...
public class ContextualTextIOTest implements Serializable {
  ...
  public void runBasicReadTestWithRFC4180Set() throws Exception {
    ...
    ContextualTextIO.Read read = ContextualTextIO.read().from(createFiles(input)).withHasRFC4180MultiLineColumn(true);
    PCollection<LineContext> output = p.apply(read);
  ...
  public static class TestOridinalLineNumber extends DoFn<Iterable<LineContext>, KV<Long,LineContext>> {
    @ProcessElement
    public void process(
